...
import type { Status as _Status, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getChannelMembers(arg0: ChannelId): Promise<Array<ProfileId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getChannelMembers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChannelMessages(arg0: ChannelId, arg1: bigint): Promise<Array<ChannelMessage>> {
        if (this.processError) {
            try {
    ...
    async getDirectMessages(arg0: ConversationId, arg1: bigint): Promise<Array<DirectMessage>> {
        if (this.processError) {
            try {
    ...
    async getPinnedMessages(arg0: ChannelId): Promise<Array<ChannelMessage>> {
        if (this.processError) {
            try {
    ...
    async joinChannel(arg0: ChannelId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async pinMessage(arg0: ChannelId, arg1: MessageId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendDirectMessage(arg0: ProfileId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: ChannelId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStatus(arg0: Principal, arg1: Status): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStatus(arg0, to_candid_Status_n13(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "away" in value ? Status.away : "offline" in value ? Status.offline : "online" in value ? Status.online : value;
}
